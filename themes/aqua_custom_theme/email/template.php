...
<?php  
	...
	$name_empresa  =  utf8_decode("Masajes Perú: Relajación");
	$link_web      = "http://masajesperu.com.pe/";
	$url_image     = "http://masajesperu.com.pe/wp-content/themes/aqua_custom_theme/assets/images/logo.png";
?>
		...
		<tr>
			<td align="center" bgcolor="<?= $bg_header; ?>" style="padding: 20px 0 20px 0;">
				...
				<a href="<?= $link_web; ?>" target="_blank" style="display:inline-block;">
					...
					<img src="<?= $url_image; ?>" alt="Mail Template by Ingenioart - JGreen" width="258" height="85" style="display: block;" />
		...
		<tr>
			<td bgcolor="<?= $bg_body; ?>" style="padding: 40px 30px 40px 30px;"> 
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
					...
					<tr>
						<td>
							<h2> <?= utf8_decode($name_empresa); ?>  </h2>
						</td>
					</tr>					
					<tr>
